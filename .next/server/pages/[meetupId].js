...
async function getStaticPaths() {
  //connect to DB
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://test-user:PAANDeZuFMB3kRZY@cluster0.erxnr.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
